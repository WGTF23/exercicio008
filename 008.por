//Neste exemplo pede o nome do usuário a 3 valores inteiros, os quais representam a quantidade de porcas, parafusos e arruelas compradas. Após, exibe o nome do usuário seguido da quantidade de  
...
programa {
  ...
  //Cálculo dos valores a serem pagos. O cálculo é feito multiplicando a quantidade de items vendidos pelo preço de cada item
...
escreva ("Parafusos: ", quantidade_porcas, "\n")
escreva ("==========================\n")
